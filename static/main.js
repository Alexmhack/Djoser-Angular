...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.register = function (user) {
        var registerUrl = this.url + '/auth/users/create/';
        return this.http.post(registerUrl, JSON.stringify(user), this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError("register error for Username=" + user.username)));
    };
    // logout the user
    UserService.prototype.logout = function () {
        var logoutUrl = this.url + '/logout/';
        return this.http.post(logoutUrl, JSON.stringify(this.token.auth_token), this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError("logout error")));
    };
    /**
...
module.exports = __webpack_require__(/*! F:\coder\Djoser-Angular\frontend\src\main.ts */"./src/main.ts");
